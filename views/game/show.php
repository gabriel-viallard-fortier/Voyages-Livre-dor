    ...
    <section>
        <div class="center-box">
            ...
            <span class="placement-button">
                ...
                <?php else: ?>
                    <div tabindex="4" class="message">Désolé ! Ce jeux n'est plus disponible en stock.</div>
                <?php endif; ?>
            </span>
        ...
        <div class="textfield">
            ...
            <div class="auteur">
                <p tabindex="5">par <?php e($editor); ?> sur <?php e($plateform); ?></p>
            </div>
            <p tabindex="5">genre: <?php e($genre); ?></p>
            <p tabindex="5">pegi: <?php e($pegi); ?></p>
            <p tabindex="3">description:</p>
            <div tabindex="3" class="scroll-box"><?php e($description); ?> </div>
        </div>
    </section>
</div>
